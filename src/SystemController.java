...
public class SystemController {
	...
	public static int menuStack(){
		...
		System.out.println("5 - Verificar se elemento existe");
	...
	public static int menuList(){
		...
		System.out.println("13 - Verificar se elemento existe");
	...
	public static boolean continua(String frase) {
